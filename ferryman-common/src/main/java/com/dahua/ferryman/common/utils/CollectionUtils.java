...
public class CollectionUtils {
    ...
    public static Map<String, Map<String, String>> splitAll(Map<String, List<String>> list, String separator) {
        ...
        for (Map.Entry<String, List<String>> entry : list.entrySet()) {
            result.put(entry.getKey(),
                    split(entry.getValue(), separator));
        }
        return result;
    }
    ...
    public static Map<String, String> split(List<String> list, String separator) {
        ...
        for (String item : list) {
            ...
            if (index == -1) {
                ...
                map.put(item.substring(0, index),
    ...
    public static boolean isEmptyMap(@SuppressWarnings("rawtypes") Map map) {
        return map == null || map.size() == 0;
    }

    public static boolean isNotEmptyMap(@SuppressWarnings("rawtypes") Map map) {
